...
ALTER TABLE fornecedores CHANGE COLUMN forn_name forn_nome VARCHAR(45);
ALTER TABLE fornecedores MODIFY COLUMN forn_nome VARCHAR(45);
ALTER TABLE fornecedores ADD INDEX idx_nome (forn_nome);
